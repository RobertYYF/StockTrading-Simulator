...
public class ScrapHandler {
    ...
    private static String getNextReqUrl(String pageNo) {
        return "https://xueqiu.com/service/v5/stock/screener/quote/list?page=" + pageNo + "&size=2500&order=desc&orderby=percent&order_by=percent&market=CN&type=sh_sz&_=1588639128007";
    }
    ...
    public static Stock getSingleData(String stockCode) throws IOException {
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                currentStock = new Stock(stockId, stockName, Float.parseFloat(stockPrice), percent);
    ...
    public Map<String, Stock> getTopTradeAmount() throws IOException {

        Map<String, Stock> store = new HashMap<>();

        String url = "https://xueqiu.com/service/v5/stock/screener/quote/list?type=sha&order_by=amount&order=desc&size=10&page=1&_=1609824330870";
